    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary"style="backround-color:pink;" href="{{ route('produks.index') }}"> Back</a>
            </div>
        </div>
    </div>
        ...
        @method('PUT')
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
              <button type="submit" class="btn btn"style="background-color:pink;">Submit</button>
            </div>
        </div>
