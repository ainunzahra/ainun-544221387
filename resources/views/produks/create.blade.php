...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            <a class="btn btn-primary"style="background-color:brown;" href="{{ route('produks.index') }}"> Back</a>
        </div>
    </div>
</div>
    ...
    @csrf
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <button type="submit" class="btn btn-primary" style="background-color:chocolate">Submit</button>
        </div>
    </div>
